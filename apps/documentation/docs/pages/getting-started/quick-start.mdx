...
First run takes 5-10 minutes to download images and compile contracts. Wait for:

> **ARM64 users** (Apple Silicon, Oracle Cloud ARM): See [ARM64 Deployment](/deployment/localnet#arm64-deployment-apple-silicon--oracle-cloud-arm) for faster setup using pre-built contracts.
