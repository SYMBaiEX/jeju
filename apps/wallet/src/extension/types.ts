 ...
 */
export type ProviderEventName = 'chainChanged' | 'accountsChanged' | 'connect' | 'disconnect' | 'message';
 ...
 */
export type ProviderEventCallback<T extends ProviderEventName = ProviderEventName> = 
